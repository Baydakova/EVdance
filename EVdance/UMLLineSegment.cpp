   ...
   ============================================================*/
{
	...
	SetStartLabel( _T( "" ) );
	SetEndLabel( _T( "" ) );
	SetWidth(theApp.m_LinkWidth);
	SetColor(theApp.m_LinkColor);
   ...
   ============================================================*/
{
	...
	if( !( GetStyle() & STYLE_INVISIBLE ) )
	{
		...
		if (GetStyle() & STYLE_DASHED)
			pen.CreatePen(PS_DOT, GetWidth(), GetColor());
		else
			pen.CreatePen(PS_SOLID, GetWidth(), GetColor());
...
void CUMLLineSegment::SetWidth(int width)
{
	m_width = width;
}

void CUMLLineSegment::SetColor(COLORREF color)
{
	m_color = color;
}
...
int CUMLLineSegment::GetWidth() const
{
	return m_width;

}

COLORREF CUMLLineSegment::GetColor() const
{
	return m_color;
   ...
   ============================================================*/
{
	...
	str.Format(_T(",%s,%s,%s,%s,%i,%i,%i,%s,%i,%s,%s,%i,%i,%s,%s,%ld,%ld;"),
		package,
		stereotype,
		GetLink(LINK_START),
		GetLink(LINK_END),
